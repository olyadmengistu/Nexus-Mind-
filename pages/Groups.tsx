...
const Groups: React.FC<GroupsProps> = ({ user }) => {
  ...
  useEffect(() => {
    ...
    const sampleGroups: Group[] = [
      {
        ...
        name: 'Problem Solving Masters',
        description: 'A community dedicated to mastering problem-solving techniques and sharing strategies.',
        category: 'Education',
      ...
      },
      {
        ...
        creatorAvatar: 'https://picsum.photos/seed/johndoe/100/100',
        name: 'Business Collaboration Hub',
        description: 'Network with business professionals and find collaboration opportunities.',
        category: 'Business',
        avatar: 'https://picsum.photos/seed/group1/100/100',
        coverImage: 'https://picsum.photos/seed/cover1/800/200',
        members: [],
      ...
      },
      {
        ...
        description: 'Share health tips, wellness routines, and support each other\'s journey.',
        category: 'Health',
        avatar: 'https://picsum.photos/seed/group1/100/100',
        coverImage: 'https://picsum.photos/seed/cover1/800/200',
        members: [],
      ...
      },
      {
        ...
        description: 'A space for artists to share work, get feedback, and collaborate on projects.',
        category: 'Arts',
        avatar: 'https://picsum.photos/seed/group1/100/100',
        coverImage: 'https://picsum.photos/seed/cover1/800/200',
        members: [],
    ...
    // Add sample posts to groups
    sampleGroups[0].posts = [
      {
        id: 'post1',
        groupId: '1',
        userId: 'user1',
        ...
        content: 'Just discovered a new problem-solving framework that\'s been incredibly effective. Has anyone else tried the "5 Whys" method?',
      ...
      },
      {
        ...
        userName: 'Jane Smith',
        userAvatar: 'https://via.placeholder.com/40',
        content: 'Yes! The 5 Whys method is fantastic. I use it daily in my work. Here\'s a quick tip: always dig deeper than you think you need to.',
