...
const Messages: React.FC<MessagesProps> = ({ user }) => {
  ...
  useEffect(() => {
    const storedConversations = localStorage.getItem('nexus_conversations');
      ...
      const defaultConversations: Conversation[] = [
        {
          id: 'c1',
          participants: [
            { id: 'u1', name: 'Sarah Chen', username: 'sarah', email: 'sarah@example.com', avatar: 'https://picsum.photos/seed/sarah/100/100', reputation: 1250 },
            user
          ],
          messages: [
            { id: 'm1', senderId: 'u1', text: 'Hello! I saw your post about the virtual list problem.', timestamp: Date.now() - 3600000 },
            { id: 'm2', senderId: user.id, text: 'Hey Sarah! Yeah, it\'s been a nightmare for performance.', timestamp: Date.now() - 3000000 },
            { id: 'm3', senderId: 'u1', text: 'Check out React Window or TanStack Virtual. They are lifesavers.', timestamp: Date.now() - 2400000 }
          ],
          lastMessage: 'Check out React Window or TanStack Virtual. They are lifesavers.',
          time: formatTime(Date.now() - 2400000)
        },
        {
          id: 'c2',
          participants: [
            { id: 'u2', name: 'John Doe', username: 'john', email: 'john@example.com', avatar: 'https://picsum.photos/seed/john/100/100', reputation: 840 },
            user
          ],
          messages: [
            { id: 'm4', senderId: 'u2', text: 'Looking for a business mentor.', timestamp: Date.now() - 7200000 }
          ],
          lastMessage: 'Looking for a business mentor.',
          time: formatTime(Date.now() - 7200000)
        },
        {
          id: 'c3',
          participants: [
            { id: 'u3', name: 'Alex River', username: 'alex', email: 'alex@example.com', avatar: 'https://picsum.photos/seed/alex/100/100', reputation: 950 },
            user
          ],
          messages: [
            { id: 'm5', senderId: 'u3', text: 'Thanks for the feedback on the logo.', timestamp: Date.now() - 172800000 }
          ],
          lastMessage: 'Thanks for the feedback on the logo.',
          time: formatTime(Date.now() - 172800000)
        }
      ];
      setConversations(defaultConversations);
      localStorage.setItem('nexus_conversations', JSON.stringify(defaultConversations));
      setSelectedChat('c1');
    }
  }, [user]);
