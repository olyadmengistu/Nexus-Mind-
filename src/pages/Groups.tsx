            ...
            <div className="p-6 relative">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-600 text-sm line-clamp-2">{selectedGroup.description}</p>
                ...
                {isMember(selectedGroup) ? (
                  ...
                  >
                    <i className="fa-solid fa-right-from-bracket mr-2"></i>Leave
                  </button>
                ) : (
                  <button
                  ...
                  >
                    <i className="fa-solid fa-user-plus mr-2"></i>Join
                  </button>
                )}
              </div>
            </div>
                  ...
                  <div className="mt-4 flex gap-3">
                    ...
                    <div className="flex-1 flex gap-2">
                      ...
                      <button
                        ...
                        className="px-3 py-2 bg-[#1877F2] text-white rounded-lg"
                      >
